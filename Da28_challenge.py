...
def strength():
  strengthStat = ((rollDice(6) * rollDice(12)) / 2) + 10
  return strengthStat
...
while True:
  ...
  if c1Dice > c2Dice:
    c2Health -= difference
    if round == 1:
      print(c1Name, "wins the first round")
    else:
    ...
    print("There swords clash and they drow round", round)
